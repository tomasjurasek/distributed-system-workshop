...
builder.Services.AddMassTransit(mt =>
{
    mt.UsingRabbitMq((context, cfg) =>
    {
        ...
        cfg.Message<OrderCanceled>(e => e.SetEntityName("order-canceled"));
        cfg.Publish<OrderCanceled>(e => e.ExchangeType = ExchangeType.Topic);

        cfg.Message<OrderDeliveryAddressChanged>(e => e.SetEntityName("order-delivery-address-changed"));
        cfg.Publish<OrderDeliveryAddressChanged>(e => e.ExchangeType = ExchangeType.Topic);
